...
class GOOGLE_API_3
{
	...
	var $zoom=12; // Zoop Level.
	var $center_lat='-3.072295'; // google map center location 
	var $center_lng='-59.97367'; // google map center location
	var $divID=''; // The div id where you want to 	place your google map
	...
	private function start()
	{
      ...
      //(function() {
        /*window.onload = */function mapaGoogle(){
