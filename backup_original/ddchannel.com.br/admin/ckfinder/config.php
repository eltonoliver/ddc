...
//$url = 'http://'.$host.substr($_SERVER['SCRIPT_NAME'],0,$pos+1).'../../../../../arquivos/enviados/ckeditor/';
$url = 'http://' . $host . substr($_SERVER['SCRIPT_NAME'], 0, $pos) . 'arquivos/enviados/ckeditor/';
