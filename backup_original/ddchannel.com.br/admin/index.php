...
if ((GetDomain($_SERVER['HTTP_REFERER']) != GetDomain($url_raiz) && strlen($_SERVER['HTTP_REFERER'])) or (!strlen($_SERVER['HTTP_REFERER']) and $arquivoNome != "login.php" and $arquivoNome != "loginAlterarSenha.php")) {
